...
const data: Nursery[] = [
  {
    id: "1",
    nama: "JENIS PEMELIHARAAN",
    nilai: "landscape",
    kelas: "pemeliharaan",
    deskripsi: "Pemeliharaan area tanam seperti pemangkasan dan penyiangan",
    status: "Aktif",
  },
  {
    id: "2",
    nama: "STATUS KEGIATAN",
    nilai: "tidak_terpenuhi",
    kelas: "status",
    deskripsi: "Kegiatan tidak memenuhi target yang ditentukan",
    status: "Tidak Aktif",
  },
  {
    id: "3",
    ...
    nilai: "terpenuhi",
    kelas: "status",
    deskripsi: "Kegiatan  memenuhi target yang ditentukan",
    status: "Terhapus",
  },
  {
    id: "4",
    ...
    nilai: "apbn",
    kelas: "dana",
    deskripsi: "Anggaran berasal dari pemerintah pusat atau daerah",
    status: "Tidak Aktif",
  },
  {
    id: "5",
