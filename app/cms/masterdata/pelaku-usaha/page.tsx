...
const data: Nursery[] = [
  {
    id: "1",
    kategori_pelaku_usaha: "Perorangan",
    nama_badan_usaha: "CV AGRAPANA FOREST",
    nib: "0102240071304",
    nomor_sertifikat: "string",
    ruang_lingkup_usaha: "string",
    nama_direktur: "Rizki Praba Nugraha, S.E., M.Si",
    nomor_hp: "string",
    alamat: "string",
  },
];
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <div className="flex flex-col">
          <div className="flex items-center justify-between mb-2">
            <div>
              <Breadcrumbs items={[{ label: "Masterdata", href: "" }, { label: "Pelaku Usaha" }]} />
