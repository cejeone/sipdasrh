      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <div className="flex flex-col">
          <div className="flex items-center justify-between mb-2">
            <div>
              <Breadcrumbs items={[{ label: "Organisasi", href: "" }, { label: "UPTD" }]} />
              <div className="flex items-center gap-2 text-secondary-green">
                <IconBorderOuter />
                <h1 className="text-2xl font-bold ">UPTD</h1>
              </div>
              <p className="text-sm text-base-gray">Informasi terkait data UPTD</p>
            </div>
            <Link href="uptd/create">
