...
import { ChevronsLeft, ChevronsRight, ChevronLeft, ChevronRight, ChevronDown, Settings2Icon, Plus, Trash2Icon } from "lucide-react";
...
const data: Nursery[] = [
  {
    ...
    pejabat: "Ir. Dyah Murtiningsih, M.Hum",
    tugas_fungsi: "string",
    keterangan: "string",
  },
  {
    id: "2",
    nama: "Direktorat Perencanaan dan Evaluasi Pengelolaan Daerah Aliran Sungai",
    pejabat: "Ir. Dyah Murtiningsih, M.Hum",
    tugas_fungsi: "string",
    keterangan: "string",
  },
  {
    id: "3",
    nama: "Direktorat Penghijauan dan Perbenihan Tanaman Hutan",
    pejabat: "Ir. Dyah Murtiningsih, M.Hum",
    tugas_fungsi: "string",
    keterangan: "string",
  },
  {
    id: "4",
    nama: "Direktorat Rehabilitasi Hutan",
    pejabat: "Ir. Dyah Murtiningsih, M.Hum",
    tugas_fungsi: "string",
    keterangan: "string",
  },
  {
    id: "5",
    nama: "Direktorat Teknik Konservasi Tanah dan Reklamasi Hutan",
    pejabat: "Ir. Dyah Murtiningsih, M.Hum",
    tugas_fungsi: "string",
    keterangan: "string",
  },
  {
    id: "6",
    nama: "Direktorat Rehabilitasi Mangrove",
    pejabat: "Ir. Dyah Murtiningsih, M.Hum",
    tugas_fungsi: "string",
    keterangan: "string",
  },
...
export default function EselonII() {
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <div className="flex flex-col">
          <div className="flex items-center justify-between mb-2">
            <div>
              <Breadcrumbs items={[{ label: "Organisasi", href: "" }, { label: "Eselon II" }]} />
