        ...
        <div className="flex items-center justify-between mb-2">
          <div>
            <Breadcrumbs items={[
              ...
              { label: "Eselon II", href: "/cms/organisasi/eselon-2" }, 
              { label: "Buat Data" }
            ]} />
        ...
        <Card className="border border-border p-4 mb-2 bg-card">
          <CardContent className="grid grid-cols-1 lg:grid-cols-12 gap-4 p-0">
            <div className="col-span-12 lg:col-span-6 border-r space-y-4 pl-4">
              ...
              <InfoItem number="2" title="Eselon I" description="Pilih organisasi Eselon I sesuai struktur kelembagaan." />
              <InfoItem number="3" title="Nama" description="Masukkan nama resmi unit organisasi Eselon I sesuai struktur kelembagaan." />
              <InfoItem number="4" title="Pejabat" description="Masukkan nama pejabat yang menjabat sebagai pimpinan Eselon I tersebut." />
              <InfoItem number="5" title="Tugas dan Fungsi" description="Masukkan uraian lengkap mengenai tugas pokok dan fungsi dari Eselon I."/>
            ...
            <div className="col-span-12 lg:col-span-6">
              <Card>
                <FormEselon2Page type="ADD" ref={formRef} />
              </Card>
            </div>
          </CardContent>
        </Card>
