...
export const editEselon2 = async (eselon2Data: any, id: string) => {
  try {
...
export const detailEselon2 = async (eselon2Data: any, id: string) => {
  try {
...
export const deleteEselon2 = async (id: string) => {
  try {
