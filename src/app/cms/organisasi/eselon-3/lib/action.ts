...
export const editEselon3 = async (eselon3Data: any, id: string) => {
  try {
...
export const detailEselon3 = async (eselon3Data: any, id: string) => {
  try {
...
export const deleteEselon3 = async (id: string) => {
  try {
