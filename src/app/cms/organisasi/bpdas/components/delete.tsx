...
import { deleteBpdas, detailBpdas } from "../lib/action";
...
export default function Delete({ id, mutateBpdas }: Props) {
  const handleDelete = async () => {
    try {
      await deleteBpdas(id);
      mutateBpdas(); // Langsung panggil mutate
