...
import { FormBpthRef } from "../../components/form";
...
interface DetailBpthPageProps {
  params: Promise<Params>;
}

const DetailBpthPage: FC<DetailBpthPageProps> = (props) => {
  // setupInterceptor();
      ...
      <div className="flex flex-col">
        <div className="flex items-center justify-between mb-2">
          <div>
            ...
            <p className="text-sm text-base-gray">Form untuk melihat data BPTH</p>
          </div>
            ...
            {loading ? (
              ...
              <div className="informasi">
                ...
                <table className="text-left">
                  <tbody>
                    <tr>
                      <td className="p-2 font-semibold text-base-green text-sm">Kode BPTH</td>
                      <td className="p-2 text-sm">{data.kodeBpth}</td>
                    </tr>
                    <tr>
                      <td className="p-2 font-semibold text-base-green text-sm">Nama BPTH</td>
                      <td className="p-2 text-sm">{data.namaBpth}</td>
                    </tr>
                    <tr>
