...
export const editEselon1 = async (eselon1Data: any, id: string) => {
  try {
...
export const detailEselon1 = async (eselon1Data: any, id: string) => {
  try {
...
export const deleteEselon1 = async (id: string) => {
  try {
