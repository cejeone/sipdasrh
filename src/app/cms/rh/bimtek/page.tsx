...
const data: Nursery[] = [
  {
    id: "1",
    nama_bimtek: "Bimtek Penanaman Jenis Lok",
    subjek: "",
    program: "Rehabilitasi Hutan dan Lahan",
    bpdas: "BPDAS Brantas Sampean",
    tempat: "Balai Diklat Kehutanan Malar",
    tanggal: "05-07 Jan 2025",
    audience: "",
    materi_bimtek: "",
    vidio_bimtek: "",
    foto_bimtek: "",
  ...
  {
    id: "2",
    nama_bimtek: "Pelatihan Monitoring Rehabilitasi",
    subjek: "",
    program: "Inovasi dan Teknologi Rehabilitasi",
    bpdas: "BPDAS Ciliwung Cisadane",
    tempat: "Kampus Pusdiklat KLHK Bogor",
    tanggal: "15 Feb 2025",
    audience: "",
    materi_bimtek: "",
    vidio_bimtek: "",
  ...
  {
    id: "3",
    nama_bimtek: "Sosialisasi RHL Partisipatif",
    subjek: "",
    program: "Pemberdayaan Masyarakat",
    bpdas: "BPDAS Mamasa",
    tempat: "Kantor BPDAS Mamasa",
    tanggal: "22 Mar 2025",
    audience: "",
    materi_bimtek: "",
    vidio_bimtek: "",
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <div className="flex flex-col">
          <div className="flex items-center justify-between mb-2">
            <div>
              <Breadcrumbs items={[{ label: "RH", href: "" }, { label: "Bimtek" }]} />
              <div className="flex items-center gap-2 text-secondary-green">
                <FileText />
                <h1 className="text-2xl font-bold ">Bimtek</h1>
              </div>
              <p className="text-sm text-base-gray">Informasi terkait data Bimtek</p>
            </div>
            <Link href="bimtek/create">
