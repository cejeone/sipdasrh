...
import { Files, Image, Sprout, Save, CircleX } from "lucide-react";
  ...
  return (
    <div className="flex-1 flex flex-col overflow-hidden">
      ...
      <div className="flex items-center justify-between px-4 py-3 border-b">
        <div>
          <div className="text-sm text-base-gray mb-1">Rencana Kerja / Kegiatan / Buat Data</div>
          <div className="flex items-center gap-2 mb-1">
            <IconBorderOuter />
            <h1 className="text-2xl font-bold text-secondary-green">Kegiatan</h1>
          </div>
          <p className="text-sm text-base-gray">Form untuk membuat data kegiatan</p>
        </div>
