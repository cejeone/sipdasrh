...
import { SquareDashed, Frame, Save, CircleX, CircleDollarSign, Sprout, Calendar as CalendarIcon } from "lucide-react";
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="border rounded-lg p-6 space-y-5">
            <div className="space-y-3">
              <Label htmlFor="kode-pp" className="text-green-800">
                Nomor
              </Label>
