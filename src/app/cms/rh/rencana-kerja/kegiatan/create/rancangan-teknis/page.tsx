...
import { SquareDashed, Frame, Save, CircleX, CircleDollarSign, Sprout } from "lucide-react";
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="border rounded-lg p-6 space-y-4">
            <h2 className="font-semibold text-lg text-green-800 flex items-center gap-2">
              <Frame /> Rancangan Teknis
            </h2>

            <div className="space-y-3 text-sm text-gray-800">
              <div>
                <strong>1. File PDF SUNLAISAH Rancangan Teknis</strong>
                <p className="ml-4 mt-1">Unggah file SUNLAISAH rancangan teknis pelaksanaan dengan format .pdf</p>
              </div>
              <div>
                <strong>2. Foto Lapangan Penyusunan Rancangan Teknis</strong>
              ...
              <div>
                <strong>3. Video Lapangan Penyusunan Rancangan Teknis</strong>
          ...
          <div className="border rounded-lg p-6 space-y-5">
            <div className="space-y-3">
              <label className="text-green-800 font-semibold">File PDF SUNLAISAH Rancangan Teknis</label>
              <div {...getRootProps()} className="border border-green-400 border-dashed rounded-lg p-6 text-center bg-white-50 cursor-pointer hover:bg-green-100 transition">
                <input {...getInputProps()} />
              ...
              {selectedFile && <p className="text-sm text-green-700">File terpilih: {selectedFile.name}</p>}
            </div>

            <div className="space-y-3">
              <label className="text-green-800 font-semibold">Foto Lapangan Penyusunan Rancangan Teknis</label>
              <div {...getRootProps()} className="border border-green-400 border-dashed rounded-lg p-6 text-center bg-white-50 cursor-pointer hover:bg-green-100 transition">
                <input {...getInputProps()} />
                <div className="flex flex-col items-center justify-center text-green-800">
                  <svg className="w-10 h-10 mb-2" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
            ...
            <div className="space-y-3">
              <label className="text-green-800 font-semibold">Video Lapangan Penyusunan Rancangan Teknis</label>
              <div {...getRootProps()} className="border border-green-400 border-dashed rounded-lg p-6 text-center bg-white-50 cursor-pointer hover:bg-green-100 transition">
                <input {...getInputProps()} />
                <div className="flex flex-col items-center justify-center text-green-800">
                  <svg className="w-10 h-10 mb-2" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
