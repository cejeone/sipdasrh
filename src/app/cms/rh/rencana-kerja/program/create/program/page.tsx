      ...
      <div className="p-6 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="border rounded-lg p-6 space-y-5">
            ...
            <div className="space-y-3">
              <Label htmlFor="tahun-rencana" className="text-green-800">
                Tahun Rencana
              </Label>
            ...
            <div className="space-y-3">
              <Label htmlFor="total-anggaran" className="text-green-800">
                Total Anggaran
              </Label>
            ...
            <div className="space-y-3">
              <Label htmlFor="total-bibit" className="text-green-800">
                Total Bibit
              </Label>
            ...
            <div className="space-y-3">
              <Label htmlFor="target-luas" className="text-green-800">
                Target Luas
              </Label>
