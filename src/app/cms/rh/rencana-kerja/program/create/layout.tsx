...
import { SquareDashed, CircleDollarSign, Sprout, Save, CircleX } from "lucide-react";
  ...
  return (
    <div className="flex-1 flex flex-col overflow-hidden">
      ...
      <div className="flex items-center justify-between px-4 py-3 border-b">
        <div>
          <div className="text-sm text-base-gray mb-1">Rencana Kerja / Program / Buat Data</div>
          <div className="flex items-center gap-2 mb-1">
            <IconBorderOuter />
            <h1 className="text-2xl font-bold text-secondary-green">Program</h1>
          </div>
          <p className="text-sm text-base-gray">Form untuk membuat data program</p>
        </div>
        ...
        {tabs.map((tab) => (
          <button
            ...
            className={`flex items-center gap-2 px-4 py-2 text-sm font-medium rounded-t ${
              activeTab === tab.id ? "bg-white border border-b-0 text-green-800" : "text-gray-500 hover:text-green-700"
            }`}
