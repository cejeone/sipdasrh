...
interface EditMonevPageProps {
  params: Promise<Params>;
}

const EditMonevPage: FC<EditMonevPageProps> = (props) => {
  // setupInterceptor();
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await AxiosInstancePepdas.get<Monev>(`/monevs/${id}`);
    ...
    <div className="flex-1 flex flex-col overflow-hidden">
      ...
      <div className="flex flex-col">
        <div className="flex items-center justify-between mb-2">
          <div>
            <Breadcrumbs items={[{ label: "PEPDAS", href: "" }, { label: "Monev", href: "/cms/rh/monev" }, { label: "Ubah Data" }]} />
            ...
            <p className="text-sm text-base-gray">Form untuk mengubah data monev</p>
          </div>
        ...
        <Card className="border border-border p-4 mb-2 bg-card">
          <CardContent className="grid grid-cols-1 lg:grid-cols-12 gap-4 p-0">
            <div className="col-span-12 lg:col-span-6 border-r space-y-4 pl-4">
              ...
              <InfoItem number="3" title="Monev ID" description="Masukkan ID unik untuk monev yang akan diregistrasi." />
              <InfoItem
                number="4"
                title="URL"
            ...
            <div className="col-span-12 lg:col-span-6">
              <Card>
                <FormMonevPage type="EDIT" ref={formRef} defaultValues={data} />
              </Card>
            </div>
          </CardContent>
        </Card>
