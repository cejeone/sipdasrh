...
interface Props {
  id: string;
  mutateKonfigurasiSistem: () => void;
}

export default function Delete({ id, mutateKonfigurasiSistem }: Props) {
  const handleDelete = async () => {
    try {
      await deleteKonfigurasiSistem(id);
      mutateKonfigurasiSistem(); // Langsung panggil mutate
