...
import { Program, ProgramResponse } from "@/model/pepdas/Program";
...
export default function ProgramPage() {
  ...
  const { data: currentData, isLoading, mutate } = useSWR<ApiResponse<ProgramResponse>>(swrKey, fetcherPepdas);

  const geoServiceList: Program[] = currentData?._embedded?.programList ?? [];
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <div className="flex flex-col">
          <div className="flex items-center justify-between mb-2">
            <div>
              <Breadcrumbs items={[{ label: "PEPDAS", href: "" }, { label: "Program" }]} />
