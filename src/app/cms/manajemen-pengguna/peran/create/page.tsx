    ...
    <div className="flex-1 flex flex-col overflow-hidden">
      ...
      <div className="flex flex-col">
        <div className="flex items-center justify-between mb-2">
          <div>
            <Breadcrumbs items={[{ label: "Peran", href: "/cms/peran" }, { label: "Buat Data" }]} />
            ...
            <p className="text-sm text-base-gray">Form untuk membuat data peran</p>
          </div>
          <div className="pt-4 flex justify-end gap-2">
            <ButtonSubmit onClick={() => formRef.current?.submit()} />
            <Link href="/cms/manajemen-pengguna/peran">
        ...
        <Card className="border border-border p-4 mb-2 bg-card">
          <CardContent className="grid grid-cols-1 lg:grid-cols-12 gap-4 p-0">
            ...
            <div className="col-span-12 lg:col-span-6">
              <Card>
                <FormPeranPage type="ADD" ref={formRef} />
              </Card>
            </div>
          </CardContent>
        </Card>
...
export default CreatePeranPage;
