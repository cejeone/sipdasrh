...
import { ChevronsLeft, ChevronsRight, ChevronLeft, ChevronRight, ChevronDown, Settings2Icon, Plus, Trash2Icon, UserCheck2 } from "lucide-react";
...
const data: Nursery[] = [
  {
    id: "1",
    nama: "SUPERADMIN",
    deskripsi: "Peran untuk Superadmin",
    status: "Aktif",
  },
];
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <div className="flex flex-col">
          <div className="flex items-center justify-between mb-2">
            <div>
              <Breadcrumbs items={[{ label: "Manajemen Pengguna", href: "" }, { label: "Peran" }]} />
