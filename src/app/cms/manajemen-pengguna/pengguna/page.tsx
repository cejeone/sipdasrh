...
import { ChevronsLeft, ChevronsRight, ChevronLeft, ChevronRight, ChevronDown, Settings2Icon, Plus, Trash2Icon, User } from "lucide-react";
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <div className="flex flex-col">
          <div className="flex items-center justify-between mb-2">
            <div>
              <Breadcrumbs items={[{ label: "Manajemen Pengguna", href: "" }, { label: "Pengguna" }]} />
              <div className="flex items-center gap-2 text-secondary-green">
                <User />
                <h1 className="text-2xl font-bold ">Pengguna</h1>
              </div>
              <p className="text-sm text-base-gray">Informasi terkait data pengguna</p>
            </div>
