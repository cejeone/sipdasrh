      ...
      <Card className="border border-border p-4 mb-2 bg-card">
        <CardContent className="grid grid-cols-1 lg:grid-cols-12 gap-4 p-0">
          <div className="col-span-12 lg:col-span-6 border-r space-y-4 pl-4">
            ...
            <InfoItem number="5" title="Tipe Institusi" description="Klasifikasi institusi berdasarkan sifat organisasinya, seperti Pemerintah, Swasta, Lembaga Riset, atau Akademik." />
            <InfoItem number="6" title="Tipe Akreditasi" description="Status atau jenis akreditasi resmi yang dimiliki institusi, yang menunjukkan tingkat kualitas, kualifikasi, atau pengakuan lembaga oleh otoritas yang relevan." />
          </div>
      ...
      <Card className="border border-border p-4 mb-2 bg-card">
        <CardContent className="grid grid-cols-1 lg:grid-cols-12 gap-4 p-0">
          <div className="col-span-12 lg:col-span-6 border-r space-y-4 pl-4">
            ...
            <InfoItem number="5" title="Kode Pos" description="Masukkan kode pos sesuai dengan wilayah domisili institusi untuk keperluan pengiriman surat atau keperluan administratif lainnya." />
