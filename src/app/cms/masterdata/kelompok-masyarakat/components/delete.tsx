...
interface Props {
  id: number;
  mutateKelompokMasyarakat: () => void;
}

export default function Delete({ id, mutateKelompokMasyarakat }: Props) {
  const handleDelete = async () => {
    try {
      await deleteKelompokMasyarakat(id);
      mutateKelompokMasyarakat(); // Langsung panggil mutate
