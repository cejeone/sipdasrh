...
interface Props {
  id: number;
  mutateKelurahanDesa: () => void;
}

export default function Delete({ id, mutateKelurahanDesa }: Props) {
  const handleDelete = async () => {
    try {
      await deleteKelurahanDesa(id);
      mutateKelurahanDesa(); // Langsung panggil mutate
