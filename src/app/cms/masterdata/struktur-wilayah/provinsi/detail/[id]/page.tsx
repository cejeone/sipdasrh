...
import { FormProvinsiRef } from "../../components/form";
...
interface DetailProvinsiPageProps {
  params: Promise<Params>;
}

const DetailProvinsiPage: FC<DetailProvinsiPageProps> = (props) => {
  // setupInterceptor();
      ...
      <div className="flex flex-col">
        <div className="flex items-center justify-between mb-2">
          <div>
            ...
            <p className="text-sm text-base-gray">Form untuk melihat data provinsi</p>
          </div>
            ...
            {loading ? (
              ...
              <div className="informasi">
                ...
                <table className="text-left">
                  <tbody>
                    <tr>
                      <td className="p-2 min-w-[200px] font-semibold text-base-green text-sm">Nama Provinsi</td>
                      <td className="p-2 text-sm">{data.namaProvinsi}</td>
                    </tr>
                    <tr>
