...
import { FormKecamatanRef } from "../../components/form";
...
interface DetailKecamatanPageProps {
  params: Promise<Params>;
}

const DetailKecamatanPage: FC<DetailKecamatanPageProps> = (props) => {
  // setupInterceptor();
      ...
      <div className="flex flex-col">
        <div className="flex items-center justify-between mb-2">
          <div>
            ...
            <p className="text-sm text-base-gray">Form untuk melihat data kecamatan</p>
          </div>
                ...
                <table className="text-left">
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="p-2 text-sm">{data.kecamatan}</td>
                    </tr>
                    <tr>
