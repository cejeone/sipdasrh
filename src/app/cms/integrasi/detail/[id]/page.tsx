...
interface DetailIntegrasiPageProps {
  params: Promise<Params>;
}

const DetailIntegrasiPage: FC<DetailIntegrasiPageProps> = (props) => {
  // setupInterceptor();
      ...
      <div className="flex flex-col">
        <div className="flex items-center justify-between mb-2">
          <div>
            ...
            <p className="text-sm text-base-gray">Form untuk melihat data integrasi</p>
          </div>
            ...
            {loading ? (
              ...
              <div className="informasi">
                ...
                <table className="text-left">
                  <tbody>
                    <tr>
                      <td className="p-2 min-w-[200px] font-semibold text-base-green text-sm">URL</td>
                      <td className="p-2 text-sm">{data.url}</td>
                    </tr>
                    <tr>
                      <td className="p-2 font-semibold text-base-green text-sm">API Key</td>
                      <td className="p-2 text-sm">{data.apiKey}</td>
                    </tr>
                    <tr>
...
export default DetailIntegrasiPage;
