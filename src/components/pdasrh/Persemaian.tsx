...
export default function Persemaian() {
  return (
    <section className="relative w-full mx-auto lg:px-16 px-4 py-8">
      <h4 className="text-2xl md:text-2xl font-bold text-base-gray mb-6">Persemaian Mentawir di IKN</h4>
      ...
      {/* dashboard */}
      <h6 className="mb-6 text-secondary-green">Realisasi bibit tanaman Hutan</h6>

      <Carousel className="w-full">
        <CarouselContent>
          {dashboard.map((item) => (
            <CarouselItem key={item.id} className="sm:basis-1/2 md:basis-1/3 lg:basis-1/5">
              <Card className="text-center p-0 shadow-none border-none bg-gradient-to-b from-[#FFEFC7] to-[#E1F7ED]">
                <CardContent className="flex flex-col justify-center items-center py-4 px-0">
                  ...
                  <span className="font-light text-sm text-muted-foreground">{item.year}</span>
